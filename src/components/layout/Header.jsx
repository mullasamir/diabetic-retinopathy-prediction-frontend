...
import { Eye, Sparkles, Menu, X } from 'lucide-react';
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group relative">
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-500 via-purple-500 to-pink-500 blur-md opacity-70 animate-pulse"></div>
              ...
              {/* Glowing reflection */}
              <div className="absolute -bottom-1 w-10 h-2 bg-gradient-to-r from-blue-400 to-purple-400 blur-md opacity-60 rounded-full"></div>
            </div>

            {/* Text beside logo */}
            <div className="flex flex-col ml-2">
              <span className="text-2xl font-extrabold bg-gradient-to-r from-blue-700 via-purple-600 to-pink-500 bg-clip-text text-transparent tracking-tight">
                Retina<span className="font-light">Scan</span>
              </span>
